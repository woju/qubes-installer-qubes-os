...
class moduleClass(Module):
    ...
    def apply(self, interface, testing=False):
        try:
            ...
            self.run_command(['/usr/bin/qubes-prefs',
                '--set', 'default-template', self.default_template])
    ...
    def configure_qubes(self):
        self.show_stage('Executing configuration')
    ...
    def create_default_dvm(self):
        ...
        self.run_in_thread(self.do_create_default_dvm)

    def do_create_default_dvm(self):
        try:
    ...
    def create_config(self):
        ...
        if self.check_network.get_active():
            self.states.add


    def do_highstate(self):
